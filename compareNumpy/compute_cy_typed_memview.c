...
{
    "distutils": {
        "name": "compute_cy_typed_memview",
        "sources": [
            "compute_cy_typed_memview.pyx"
        ]
    },
    "module_name": "compute_cy_typed_memview"
}
END: Cython Metadata */
...
#define __PYX_HAVE__compute_cy_typed_memview
#define __PYX_HAVE_API__compute_cy_typed_memview
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'compute_cy_typed_memview' */
...
static int __pyx_f_24compute_cy_typed_memview_clip(int, int, int); /*proto*/
...
#define __Pyx_MODULE_NAME "compute_cy_typed_memview"
extern int __pyx_module_is_main_compute_cy_typed_memview;
int __pyx_module_is_main_compute_cy_typed_memview = 0;

/* Implementation of 'compute_cy_typed_memview' */
...
static const char __pyx_k_compute_cy_typed_memview[] = "compute_cy_typed_memview";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_compute_cy_typed_memview_pyx[] = "compute_cy_typed_memview.pyx";
...
static PyObject *__pyx_n_s_compute_cy_typed_memview;
static PyObject *__pyx_kp_s_compute_cy_typed_memview_pyx;
...
static PyObject *__pyx_pf_24compute_cy_typed_memview_compute(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_array_1, __Pyx_memviewslice __pyx_v_array_2, int __pyx_v_a, int __pyx_v_b, int __pyx_v_c); /* proto */
...
/* "compute_cy_typed_memview.pyx":5
 * DTYPE = np.intc
 * 
...
static int __pyx_f_24compute_cy_typed_memview_clip(int __pyx_v_a, int __pyx_v_min_values, int __pyx_v_max_values) {
  int __pyx_r;
  ...
  /* "compute_cy_typed_memview.pyx":6
 * 
 * cdef int clip(int a, int min_values, int max_values):
 *     return min(max(a, min_values), max_values)             # <<<<<<<<<<<<<<
 * 
...
/* "compute_cy_typed_memview.pyx":8
 *     return min(max(a, min_values), max_values)
 * 
 * def compute(int[:,:] array_1, int[:,:] array_2, int a, int b, int c):             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_24compute_cy_typed_memview_1compute(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_24compute_cy_typed_memview_1compute = {"compute", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_24compute_cy_typed_memview_1compute, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_24compute_cy_typed_memview_1compute(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("compute_cy_typed_memview.compute", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_24compute_cy_typed_memview_compute(__pyx_self, __pyx_v_array_1, __pyx_v_array_2, __pyx_v_a, __pyx_v_b, __pyx_v_c);
...
static PyObject *__pyx_pf_24compute_cy_typed_memview_compute(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_array_1, __Pyx_memviewslice __pyx_v_array_2, int __pyx_v_a, int __pyx_v_b, int __pyx_v_c) {
  ...
  /* "compute_cy_typed_memview.pyx":10
 * def compute(int[:,:] array_1, int[:,:] array_2, int a, int b, int c):
 * 
 *     cdef Py_ssize_t x_max = array_1.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "compute_cy_typed_memview.pyx":11
 * 
 *     cdef Py_ssize_t x_max = array_1.shape[0]
 *     cdef Py_ssize_t y_max = array_1.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "compute_cy_typed_memview.pyx":13
 *     cdef Py_ssize_t y_max = array_1.shape[1]
 * 
 *     assert tuple(array_1.shape) == tuple(array_2.shape)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_1 = __Pyx_carray_to_py_Py_ssize_t(__pyx_v_array_1.shape, 8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PySequence_Tuple(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_carray_to_py_Py_ssize_t(__pyx_v_array_2.shape, 8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_3 = __Pyx_PySequence_Tuple(__pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  /* "compute_cy_typed_memview.pyx":15
 *     assert tuple(array_1.shape) == tuple(array_2.shape)
 * 
 *     result = np.zeros((x_max, y_max), dtype=DTYPE)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyInt_FromSsize_t(__pyx_v_x_max); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_v_y_max); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_1) < 0) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "compute_cy_typed_memview.pyx":16
 * 
 *     result = np.zeros((x_max, y_max), dtype=DTYPE)
 *     cdef int[:, :] result_view = result             # <<<<<<<<<<<<<<
 * 
 *     cdef int tmp
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_v_result, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 16, __pyx_L1_error)
  __pyx_v_result_view = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "compute_cy_typed_memview.pyx":21
 *     cdef Py_ssize_t x, y
 * 
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "compute_cy_typed_memview.pyx":22
 * 
 *     for x in range(x_max):
 *         for y in range(y_max):             # <<<<<<<<<<<<<<
 *             tmp = clip(array_1[x, y], 2, 10)
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "compute_cy_typed_memview.pyx":23
 *     for x in range(x_max):
 *         for y in range(y_max):
 *             tmp = clip(array_1[x, y], 2, 10)             # <<<<<<<<<<<<<<
 *             tmp = tmp * a + array_2[x, y] * b
 ...
 */
      ...
      __pyx_v_tmp = __pyx_f_24compute_cy_typed_memview_clip((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_array_1.data + __pyx_t_13 * __pyx_v_array_1.strides[0]) ) + __pyx_t_14 * __pyx_v_array_1.strides[1]) ))), 2, 10);

      /* "compute_cy_typed_memview.pyx":24
 *         for y in range(y_max):
 *             tmp = clip(array_1[x, y], 2, 10)
 *             tmp = tmp * a + array_2[x, y] * b             # <<<<<<<<<<<<<<
 *             # result[x, y] = tmp + c
 ...
 */
      ...
      /* "compute_cy_typed_memview.pyx":26
 *             tmp = tmp * a + array_2[x, y] * b
 *             # result[x, y] = tmp + c
 *             result_view[x, y] = tmp + c             # <<<<<<<<<<<<<<
 *     return result
 */
  ...
  /* "compute_cy_typed_memview.pyx":27
 *             # result[x, y] = tmp + c
 *             result_view[x, y] = tmp + c
 *     return result             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "compute_cy_typed_memview.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "compute_cy_typed_memview.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "compute_cy_typed_memview.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "compute_cy_typed_memview._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_compute_cy_typed_memview(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_compute_cy_typed_memview},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_compute_cy_typed_memview, __pyx_k_compute_cy_typed_memview, sizeof(__pyx_k_compute_cy_typed_memview), 0, 0, 1, 1},
  {&__pyx_kp_s_compute_cy_typed_memview_pyx, __pyx_k_compute_cy_typed_memview_pyx, sizeof(__pyx_k_compute_cy_typed_memview_pyx), 0, 0, 1, 0},
 ...
 *     cdef Py_ssize_t x_max = array_1.shape[0]
 */
  __pyx_tuple__19 = PyTuple_Pack(12, __pyx_n_s_array_1, __pyx_n_s_array_2, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_c, __pyx_n_s_x_max, __pyx_n_s_y_max, __pyx_n_s_result, __pyx_n_s_result_view, __pyx_n_s_tmp, __pyx_n_s_x, __pyx_n_s_y); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 12, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_compute_cy_typed_memview_pyx, __pyx_n_s_compute, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 8, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcompute_cy_typed_memview(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcompute_cy_typed_memview(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_compute_cy_typed_memview(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_compute_cy_typed_memview(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_compute_cy_typed_memview(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'compute_cy_typed_memview' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_compute_cy_typed_memview(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("compute_cy_typed_memview", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_compute_cy_typed_memview) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "compute_cy_typed_memview")) {
      if (unlikely(PyDict_SetItemString(modules, "compute_cy_typed_memview", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "compute_cy_typed_memview.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * # Version 3
 * DTYPE = np.intc
 */
  ...
  /* "compute_cy_typed_memview.pyx":3
 * import numpy as np
 * # Version 3
 * DTYPE = np.intc             # <<<<<<<<<<<<<<
 * 
 ...
 *     cdef Py_ssize_t x_max = array_1.shape[0]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_24compute_cy_typed_memview_1compute, NULL, __pyx_n_s_compute_cy_typed_memview); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init compute_cy_typed_memview", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init compute_cy_typed_memview");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
